...
<div class="sk-header-row">
  <div>
    ...
    <p class="sk-page-subtitle">Rekap penarikan tabungan anggota per bulan</p>
  </div>
</div>
...
<div class="sk-card">
  <div class="sk-card-header" style="display:flex;align-items:center;justify-content:space-between;">
    <h5 class="sk-card-title"><i class="fa fa-money" style="color:#DC2626"></i>&nbsp; Data Pengambilan Periode Ini</h5>
    <a href="cetakpengambilan.php?bulan=<?php echo $bulan;?>&tahun=<?php echo $tahun ?>" target="_blank" class="sk-btn sk-btn-outline sk-btn-sm"><i class="fa fa-print"></i> Cetak</a>
  </div>
