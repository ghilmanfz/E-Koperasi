...
$_ad_seen      = $_SESSION['ad_notif_seen'] ?? [];
$show_pending  = $notif_pending  > ($_ad_seen['pending']  ?? -1);
$show_baru     = $notif_baru     > ($_ad_seen['baru']     ?? -1);
$show_pinjaman = $notif_pinjaman > ($_ad_seen['pinjaman'] ?? -1);
...
<div class="sk-wrap">
  ...
  <aside class="sk-sidebar">
    ...
    <nav class="sk-nav">
      ...
      <div class="sk-nav-section">Admin</div>
      <?php echo sk_nav('manajemenakun.php','fa-user-secret','Manajemen Akun',$cur); ?>
    </nav>

    <div class="sk-sidebar-bottom">
      <a href="settings.php" class="sk-nav-item<?php echo ($cur==='settings.php')?' active':''; ?>"><i class="fa fa-cog"></i> <span>Settings</span></a>
      ...
      <div class="sk-topbar-actions">
        ...
        <div class="sk-user">
          <div class="sk-user-info">
            <span class="sk-user-name"><?php echo htmlspecialchars($_SESSION['username'] ?? 'Admin'); ?></span>
            <span class="sk-user-role">Admin</span>
          </div>
...
var menuItems=[
  ...
  {label:'Manajemen Akun',url:'manajemenakun.php',icon:'fa-user-secret'},
