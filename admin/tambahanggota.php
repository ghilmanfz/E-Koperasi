...
<?php 
	...
	if (isset($_POST['tambah'])) {
        ...
        if (mysqli_num_rows($cekdulu)) {
            $_SESSION['flash'] = ['type' => 'error', 'msg' => 'NIK Sudah Digunakan! Gunakan NIK lain.'];
        	...
        	if ($save) {
        		$_SESSION['flash'] = ['type' => 'success', 'msg' => 'Berhasil Menambah Anggota!'];
        	} else {
        		$_SESSION['flash'] = ['type' => 'error', 'msg' => 'Gagal Menambah Anggota!'];
        	}
